...
<?php
    ...
    foreach ($accessories->getData() as $item) :
        if ($item['item_id'] == $item_id) :
?>
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6 text-center pb-5">
                <img src="<?php echo $item['item_image'] ?? "./assets/accessories/1.png" ?>" alt="accessory" class="img-fluid pb-3 pt-2">
                    ...
                    <div class="col">
                        <form method="post">
                                ...
                                if (in_array($item['item_id'], $Cart->getCartId($accessories->getData('cart')) ?? [])){
                                    ...
                                    echo '<button type="submit" name="accessories_submit" class="btn btn-warning font-size-16 form-control">Add to Cart</button>';
                                }
                                ?>
                        </form>
                    </div>
